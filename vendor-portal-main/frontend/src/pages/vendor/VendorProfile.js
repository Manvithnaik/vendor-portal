            ...
            <div className="bg-surface-50 px-6 py-4 border-b border-surface-200 flex items-center justify-between">
              ...
              {!isEditingProfile && (
                <button 
                  ...
                  className="btn-secondary text-sm py-1.5 px-4 rounded-full border-purple-200 text-purple-700 hover:bg-purple-50 transition-colors"
                >
              ...
              {isEditingProfile ? (
                ...
                <form onSubmit={handleProfileSubmit} className="space-y-6 animate-fade-in">
                  ...
                  <div className="flex justify-end gap-3 pt-4">
                    ...
                    <button type="submit" disabled={savingProfile} className="btn-primary bg-purple-600 hover:bg-purple-700 border-purple-600 px-6 rounded-full shadow-md hover:shadow-lg transition-all">
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-white p-5 rounded-xl border border-surface-200 border-l-4 border-l-purple-500 shadow-sm">
                    <h3 className="font-semibold text-brand-900 mb-4 flex items-center gap-2 border-b border-surface-100 pb-2"><Building size={18} className="text-purple-600"/> Organization Details</h3>
                  ...
                  <div className="bg-white p-5 rounded-xl border border-surface-200 border-l-4 border-l-indigo-500 shadow-sm">
                    <h3 className="font-semibold text-brand-900 mb-4 flex items-center gap-2 border-b border-surface-100 pb-2"><UserCircle size={18} className="text-indigo-600"/> Contact Person</h3>
                  ...
                  <div className="bg-white p-5 rounded-xl border border-surface-200 border-l-4 border-l-purple-500 shadow-sm">
                    <h3 className="font-semibold text-brand-900 mb-4 flex items-center gap-2 border-b border-surface-100 pb-2"><MapPin size={18} className="text-purple-600"/> Billing / Main Address</h3>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-8">
                      <div className="sm:col-span-2 border-b border-surface-50 pb-2">
